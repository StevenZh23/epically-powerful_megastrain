...
accelerometer and gyroscope of the LSM6DSOX IMUs. 
...
from epicallypowerful.sensing.lsm6dsox.lsm6dsox_imu import LSM6DSOXIMUs
...
parser = argparse.ArgumentParser(
    description="Calibrate LSM6DSOX IMU."
)
...
parser.add_argument(
    ...
    type=int,
    default=107,
    help="I2C address of LSM6DSOX sensor (e.g., --address 107). Defaults to 107 (0x6B). If the SDO/SA0 pin is low, the address is 106 (0x6A). If the SDO/SA0 pin is high, the address is 107 (0x6B).",
)
...
parser.add_argument(
    ...
    type=float,
    default=104,
    help="Frequency of LSM6DSOX sensor [Hz] (e.g., --rate 104). Defaults to 104 Hz, which is the default ODR for both accel and gyro.",
)
...
if __name__ == "__main__":
    ...
    print(f"Initializing LSM6DSOX IMU at I2C bus {bus} with address {address}")
    ...
    calibration_filename = f"lsm6dsox_calibrations.json"
    ...
    # Create instance of LSM6DSOXIMUs object to initialize connected IMU
    ...
    for component in args.components:
        ...
        if component == "acc":
            ...
            print(f"Component {component} not of type `acc` or `gyro`. Skipping...")
